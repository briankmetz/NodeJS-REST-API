...
// get next batch of emails from queue to be sent. maxSendRate can be set in .env file
...
// Sends emails using Amazon's Simple Email Service
async function sendMail(mail){
	if(!config.aws.config.accessKeyId || config.aws.config.accessKeyId == 'YOUR_AWS_ACCESS_KEY'){
		console.log('AWS not configured. Canceling email send.');
		return;
	}
